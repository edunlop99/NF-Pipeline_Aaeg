...
workflow  {
    ...
    trim_reports
        .mix(star_logs, star_gene_counts) //add back , rrna_virna_logs
        .collect()
    ...
    bigwig_out = BAMCOVERAGE.out.bigwigs // tuple val(sample_name), path(bw_fwd), path(bw_rev)
    ...
    RSEQC_RD(dedup_ch, params.reference_bed)
    RSEQC_GB(dedup_ch, params.reference_bed)
    // collect for multiqc
    ...
    // https://www.biostars.org/p/9558370/?__cf_chl_f_tk=zR6c5ccqm4I0b4iq6BQcDKxJ6H1q6zhTFbGj7IWJ53E-1783349003-1.0.1.1-i.GUIbcBeu5i1YOxN5kChqv6TWTQX82hzlrpnHRaqIg
    ...
    // stringtie_counts_ch = PREPDE.out.gene_counts
